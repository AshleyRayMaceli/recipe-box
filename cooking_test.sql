...
SELECT pg_catalog.setval('ingredients_id_seq', 262, true);
...
SELECT pg_catalog.setval('ingredients_recipes_id_seq', 140, true);
...
SELECT pg_catalog.setval('recipes_id_seq', 292, true);
